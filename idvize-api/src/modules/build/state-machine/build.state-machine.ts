...
const ALLOWED_TRANSITIONS: AllowedTransitions = {
  ...
  ASSIGNED: ['AWAITING_APPROVAL', 'READY_TO_BUILD', 'CANCELLED'],
  AWAITING_APPROVAL: ['AWAITING_FORM', 'READY_TO_BUILD', 'FAILED', 'CANCELLED'],
  AWAITING_FORM: ['READY_TO_BUILD', 'OUTREACH_SENT', 'DATA_COLLECTED', 'FAILED', 'CANCELLED'],
...
const STATE_LABELS: Record<BuildState, string> = {
  ...
  AWAITING_FORM: 'Awaiting Information',
