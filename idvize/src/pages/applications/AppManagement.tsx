  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ChartCard title="Orphan Accounts" subtitle="Current status breakdown">
          <DonutChart
        ...
        <ChartCard title="Login Failure Trend" subtitle="Failures vs resolved per month">
          <VerticalBarChart
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ChartCard title="Terminated Accounts Trend" subtitle="Weekly terminated account count">
          <TrendLineChart
        ...
        <ChartCard title="User Termination Completion Rate" subtitle="Monthly completion rate (%)">
          <VerticalBarChart
