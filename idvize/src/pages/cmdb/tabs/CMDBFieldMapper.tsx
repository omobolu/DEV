  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-surface-800 border border-surface-700 rounded-xl p-5">
        <p className="text-sm font-semibold text-slate-200 mb-4">Field Mappings</p>
        <FieldMappingTable
      ...
      <div className="bg-surface-800 border border-surface-700 rounded-xl p-4">
        ...
        <ul className="text-xs text-slate-500 space-y-1 list-disc list-inside">
          <li>Use <span className="text-slate-400 font-mono">Auto-suggest all</span> to let idvize fuzzy-match column names automatically</li>
          <li>Set unmapped columns to <span className="text-slate-400 font-mono">— Ignore —</span> to skip them on import</li>
