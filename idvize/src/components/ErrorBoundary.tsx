        ...
        <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
          <div className="max-w-md w-full text-center">
            ...
            {import.meta.env.DEV && this.state.error && (
              <pre className="text-left text-xs text-red-400 bg-surface-800 border border-surface-700 rounded-lg p-4 mb-6 overflow-x-auto max-h-32">
            ...
            <div className="flex items-center justify-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-300 border border-surface-600 rounded-lg hover:bg-surface-700 transition-colors"
              >
                Try again
              </button>
              <button
